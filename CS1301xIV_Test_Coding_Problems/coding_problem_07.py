...
# index_list = [0, 2]
# alter_list(strings_list, index_list) -> 
...
def alter_list(strings_list: List[str], indices_list: List[int]) -> list:
    for index in indices_list:
        if strings_list[index].isupper():
            strings_list[index] = strings_list[index].lower()
        else:
            strings_list[index] = strings_list[index].upper()
    return strings_list
