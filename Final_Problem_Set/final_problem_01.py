...
def to_dictionaries(nations_list: List[Nation]) -> Dict[str, Dict[str, Union[str, int]]]:
    nation_dict = {}
    ...
    #     nation_dict[nation.short_name] = {}
    #     nation_dict[nation.short_name]['long_name'] = nation.long_name
    #     nation_dict[nation.short_name]['iso_code'] = nation.iso_code
    #     nation_dict[nation.short_name]['iso_short'] = nation.iso_short
    #     nation_dict[nation.short_name]['iso_long'] = nation.iso_long
    #     nation_dict[nation.short_name]['capital'] = nation.capital
