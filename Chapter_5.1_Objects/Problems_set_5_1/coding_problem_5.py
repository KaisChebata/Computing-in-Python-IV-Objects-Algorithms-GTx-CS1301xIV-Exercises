...
def find_net_force(force_list: List[Force]) -> Force:
    ...
    angle_net_force = round(degrees(atan2(total_vertical, total_horizontal)), 1)

    return Force(net_force, angle_net_force)
